    ...
    <script type="text/javascript">
        ...
        function doDelete() {
            ...
            if (rows.length == 0) {
                ...
                $.messager.confirm("提示信息","您确定要删除选定的取派员吗？",function (b) {
                    if(b){
                        var array = new Array();
                        ...
                        var s = array.join(",");
                        location.href="${pageContext.request.contextPath}/staffAction_delete?ids="+s;
                    }
                });
            }
        }
        ...
        $(function () {
            ...
            $('#grid').datagrid({
                ...
                pageList: [1, 2, 3, 4],
                toolbar: toolbar,
                url: "${pageContext.request.contextPath}/staffAction_pageList",
                idField: 'id',
                columns: columns,
