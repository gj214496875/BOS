...
<script type="text/javascript">
    ...
    $(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/subareaAction_pageList",
			idField : 'id',
			columns : columns,
		...
		$("#save").click(function () {
            var b = $("#addSubareaForm").form("validate");
            if(b){
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							...
    							mode:'remote',
    							url:'${pageContext.request.contextPath}/regionAction_regionAjax'" />
						</td>
					</tr>
					<tr>
						<td>关键字</td>
