    ...
    <script type="text/javascript">
        ...
        function doAssociations() {
            ...
            if (rows.length != 1) {
                ...
                $.post("${pageContext.request.contextPath}/decidedzoneAction_findNotDecidedzoneId", {}, function (data) {
                    for (var i = 0; i < data.length; i++) {
                        $("#noassociationSelect").append("<option value='" + data[i].id + "'>" + data[i].name + "(" +
                            data[i].telephone + ")</option>");
                    }
                }, "json");
                $.post("${pageContext.request.contextPath}/decidedzoneAction_findHasDecidedzoneId", {"id":rows[0].id},
                    function (data) {
                    for (var i = 0; i < data.length; i++) {
                        $("#associationSelect").append("<option value='" + data[i].id + "'>" + data[i].name + "(" +
                            data[i].telephone + ")</option>");
                    }
                }, "json");
        ...
        $(function () {
            ...
            $('#grid').datagrid({
                ...
                pagination: true,
                toolbar: toolbar,
                url: "${pageContext.request.contextPath}/decidedzoneAction_pageList",
                idField: 'id',
                columns: columns,
        ...
        function doDblClickRow(index,data) {
            $('#association_subarea').datagrid({
                ...
                rownumbers: true,
                striped: true,
                url: "${pageContext.request.contextPath}/subareaAction_listByDecidedzoneId?decidedzoneId="+data.id,
                columns: [[{
                    field: 'id',
                    title: '分拣编号',
                    width: 320,
            ...
            $('#association_customer').datagrid({
                ...
                rownumbers: true,
                striped: true,
                url: "${pageContext.request.contextPath}/decidedzoneAction_findHasDecidedzoneId?id="+data.id,
                columns: [[{
                    field: 'id',
                    title: '客户编号',
                    width: 120,
...
<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false"
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form action="${pageContext.request.contextPath}/decidedzoneAction_add" id="addDecidedzoneForm" method="post">
                ...
                <tr>
                    ...
                    <td>
                        <input class="easyui-combobox" name="staff.id"
                               data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/staffAction_listAjax'"/>
                    </td>
                </tr>
                <tr height="300">
                    ...
                    <td>
                        <table id="subareaGrid" class="easyui-datagrid" border="false" style="width:300px;height:300px"
                               data-options="url:'${pageContext.request.contextPath}/subareaAction_listAjax',
                                   fitColumns:true,
                                   singleSelect:false">
                            <thead>
                            <tr>
