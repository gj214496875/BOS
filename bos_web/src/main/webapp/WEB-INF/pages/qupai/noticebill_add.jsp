    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("input[name=telephone]").blur(function(){
                ...
                $.post("${pageContext.request.contextPath }/noticebillAction_findCustomerBytelephone",{"telephone":telephone},function
                    (data) {
                    if(data != null){
...
<div region="center" style="overflow:auto;padding:5px;" border="false">
    <form id="noticebillForm" action="noticebillAction_add" method="post">
        <table class="table-edit" width="95%" align="center">
            ...
            <tr>
                <td>来电号码:</td>
                <td><input type="text" class="easyui-validatebox" name="telephone" required="true" equired="true"/></td>
                <td>客户编号:</td>
