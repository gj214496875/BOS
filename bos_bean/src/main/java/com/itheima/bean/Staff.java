...
public class Staff {
    ...
    public boolean equals(Object o) {
        ...
        if (telephone != null ? !telephone.equals(staff.telephone) : staff.telephone != null) {
            return false;
        }
        if (haspda != null ? !haspda.equals(staff.haspda) : staff.haspda != null) {
            return false;
        }
        if (deltag != null ? !deltag.equals(staff.deltag) : staff.deltag != null) {
            return false;
        }
        if (station != null ? !station.equals(staff.station) : staff.station != null) {
            return false;
        }
        if (standard != null ? !standard.equals(staff.standard) : staff.standard != null) {
            return false;
        }
        return true;
    }
